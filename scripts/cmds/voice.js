...
<span class="hljs-keyword">const</span> supportedIds = [<span class="hljs-string">"rachel"</span>, <span class="hljs-string">"drew"</span>, <span class="hljs-string">"clyde"</span>, <span class="hljs-string">"paul"</span>, <span class="hljs-string">"domi"</span>, <span class="hljs-string">"dave"</span>, <span class="hljs-string">"fin"</span>, <span class="hljs-string">"sarah"</span>, <span class="hljs-string">"antoni"</span>, <span class="hljs-string">"thomas"</span>, <span class="hljs-string">"charlie"</span>, <span class="hljs-string">"george"</span>, <span class="hljs-string">"emily"</span>, <span class="hljs-string">"elli"</span>, <span class="hljs-string">"callum"</span>, <span class="hljs-string">"patrick"</span>, <span class="hljs-string">"harry"</span>, <span class="hljs-string">"liam"</span>, <span class="hljs-string">"dorothy"</span>, <span class="hljs-string">"josh"</span>, <span class="hljs-string">"arnold"</span>, <span class="hljs-string">"charlotte"</span>, <span class="hljs-string">"alice"</span>, <span class="hljs-string">"matilda"</span>, <span class="hljs-string">"matthew"</span>, <span class="hljs-string">"james"</span>, <span class="hljs-string">"joseph"</span>, <span class="hljs-string">"jeremy"</span>, <span class="hljs-string">"michael"</span>, <span class="hljs-string">"ethan"</span>, <span class="hljs-string">"chris"</span>, <span class="hljs-string">"gigi"</span>, <span class="hljs-string">"freya"</span>, <span class="hljs-string">"brian"</span>, <span class="hljs-string">"grace"</span>, <span class="hljs-string">"daniel"</span>, <span class="hljs-string">"lily"</span>, <span class="hljs-string">"serena"</span>, <span class="hljs-string">"adam"</span>, <span class="hljs-string">"nicole"</span>, <span class="hljs-string">"bill"</span>, <span class="hljs-string">"jessie"</span>, <span class="hljs-string">"sam"</span>, <span class="hljs-string">"glinda"</span>, <span class="hljs-string">"giovanni"</span>, <span class="hljs-string">"mimi"</span>];

<span class="hljs-variable">module</span>.<span class="hljs-property">exports</span> = {
  <span class="hljs-attr">config</span>: {
    <span class="hljs-attr">name</span>: <span class="hljs-string">"voice"</span>,
    <span class="hljs-attr">version</span>: <span class="hljs-string">"1.0"</span>,
    <span class="hljs-attr">author</span>: <span class="hljs-string">"Rishad"</span>,
    <span class="hljs-attr">countDown</span>: <span class="hljs-number">5</span>,
    <span class="hljs-attr">role</span>: <span class="hljs-number">0</span>,
    <span class="hljs-attr">category</span>: <span class="hljs-string">"Fun"</span>,
    <span class="hljs-title">ShortDescription</span>: <span class="hljs-string">"Generate voice using AI"</span>,
    <span class="hljs-title">LongDescription</span>: <span class="hljs-string">"Generates voice using an AI."</span>,
    <span class="hljs-attr">guide</span>: {
      <span class="hljs-attr">en</span>: <span class="hljs-string">"{pn} (voice id) | texts\nExample: {pn} rachel | hey there\n{pn} list | Get the list of supported voice IDs"</span>
    }
  },

  <span class="hljs-attr">onStart</span>: <span class="hljs-keyword">async</span> <span class="hljs-keyword">function</span> (<span class="hljs-params">{ api, args, message, event }</span>) {
    <span class="hljs-keyword">const</span> { getPrefix, getStreamFromURL } = <span class="hljs-variable">global</span>.<span class="hljs-property">utils</span>;
    <span class="hljs-keyword">const</span> p = <span class="hljs-title">getPrefix</span>(event.<span class="hljs-property">threadID</span>);

    <span class="hljs-keyword">const</span> command = args.<span class="hljs-title">join</span>(<span class="hljs-string">" "</span>).<span class="hljs-title">split</span>(<span class="hljs-string">"|"</span>);
    <span class="hljs-keyword">if</span> (command.<span class="hljs-property">length</span> !== <span class="hljs-number">2</span>) {
      <span class="hljs-keyword">if</span> (args[<span class="hljs-number">0</span>].<span class="hljs-title">toLowerCase</span>() === <span class="hljs-string">'list'</span>) {
        <span class="hljs-keyword">return</span> api.<span class="hljs-title">sendMessage</span>(<span class="hljs-string">`Supported voice IDs are:\n <span class="hljs-subst">${supportedIds.join(<span class="hljs-string">"\n"</span>)}</span>`</span>, event.<span class="hljs-property">threadID</span>, event.<span class="hljs-property">messageID</span>);
      }
      <span class="hljs-keyword">return</span> message.<span class="hljs-title">reply</span>(<span class="hljs-string">`❌Invalid command format. Use it like this:\n<span class="hljs-subst">${p}</span>voice rachel | Hey there`</span>);
    }

    <span class="hljs-keyword">const</span> voiceId = command[<span class="hljs-number">0</span>].<span class="hljs-title">trim</span>().<span class="hljs-title">toLowerCase</span>();
    <span class="hljs-keyword">const</span> text = command[<span class="hljs-number">1</span>].<span class="hljs-title">trim</span>();

    <span class="hljs-keyword">if</span> (!supportedIds.<span class="hljs-title">includes</span>(voiceId)) {
      <span class="hljs-keyword">return</span> message.<span class="hljs-title">reply</span>(<span class="hljs-string">`❌Invalid voice ID. Supported IDs are:\n <span class="hljs-subst">${supportedIds.join(<span class="hljs-string">"\n"</span>)}</span>`</span>);
    }

    <span class="hljs-keyword">const</span> apiKey = <span class="hljs-string">'fuck'</span>;
    <span class="hljs-keyword">const</span> apiUrl = <span class="hljs-string">`https://for-devs.onrender.com/api/voice?text=<span class="hljs-subst">${<span class="hljs-built_in">encodeURIComponent</span>(text)}</span>&amp;voiceid=<span class="hljs-subst">${voiceId}</span>&amp;apikey=<span class="hljs-subst">${apiKey}</span>`</span>;

    <span class="hljs-keyword">try</span> {
      <span class="hljs-keyword">const</span> voiceStream = <span class="hljs-keyword">await</span> <span class="hljs-title">getStreamFromURL</span>(apiUrl);

      <span class="hljs-keyword">if</span> (voiceStream) {
        <span class="hljs-keyword">return</span> api.<span class="hljs-title">sendMessage</span>({ <span class="hljs-attr">attachment</span>: voiceStream }, event.<span class="hljs-property">threadID</span>, event.<span class="hljs-property">messageID</span>);
      } <span class="hljs-keyword">else</span> {
        <span class="hljs-keyword">return</span> api.<span class="hljs-title">sendMessage</span>(<span class="hljs-string">'Failed to generate voice.'</span>, event.<span class="hljs-property">threadID</span>, event.<span class="hljs-property">messageID</span>);
      }
